...
namespace CryptoSystemExpert
{
    ...
    static class Program
    {
        ...
        static public string program4explorer = "CryptoSystemExpert.exe";
        static public string program3explorer = "CryptoSystem.exe";
        static public string program2explorer = "CryptoSystemSimple.exe";
